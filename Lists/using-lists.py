"""
From within the using-lists.py file, we'll be modifying the users list so that the assertions throughout the file all succeed eventually. 
...
users_bob_index = users.index('bob')
users.remove('bob')
...
users.insert(users_bob_index, 'melody')
...
#extender = ['andy', 'wanda', 'jim']
#users.extend(extender)
